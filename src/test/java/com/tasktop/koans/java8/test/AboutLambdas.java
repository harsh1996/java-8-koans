...
public class AboutLambdas {
	...
	public void java8_passingFunctionsWithLambdas_WithReturn_WithCurlyBrackets_AndMultiline() {
		...
		String result = yeller.yell("echo", echo -> {
			String myEcho = echo + echoSufix; // FIXME: Modify the echo and concatenate the echoSufix
			return myEcho;
		});
	...
	public void java8_passingOwnFunctionalInterfaces() {
		...
		String echo = yeller.yell("hello", "echo", (echo1, echo2) -> {
			return echo1 + " " + echo2;
		}); // FIXME: let your concatenator concatenate :)
